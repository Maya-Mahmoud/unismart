    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-16">
        ...
        <div class="flex justify-between items-center mb-6">
             <div class="section-header">
                <h1 class="section-title">Advanced Scheduler</h1>
                <p class="section-subtitle">Schedule lectures with conflict detection and recurring options</p>
            </div>
            <button id="scheduleLectureBtn" class="btn btn-green">
        ...
        <div class="bg-white rounded-lg shadow p-6 my-6 hall-card">
