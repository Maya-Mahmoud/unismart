...
<a href="{{ route('student.chat.view') }}"
   class="nav-link flex items-center {{ request()->routeIs('student.chat.view') ? 'active' : '' }} ">
    
    <svg class="w-5 h-5 mr-2 {{ request()->routeIs('student.chat.view') ? 'active' : '' }} " 
         fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
