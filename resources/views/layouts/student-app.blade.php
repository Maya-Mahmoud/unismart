...
<header>
   ...
   class="nav-link flex items-center {{ request()->routeIs('student.dashboard') ? 'active' : '' }} ">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
   ...
   class="nav-link flex items-center {{ request()->routeIs('student.subjects') ? 'active' : '' }} ">
    <svg class="w-5 h-5 mr-2 {{ request()->routeIs('student.subjects') ? 'active' : '' }}" 
     fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
        d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253">
  </path>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v4"></path>
</svg>
    
   Digital Library
</a>
           <a href="{{ route('student.scan-qr') }}" 
   class="nav-link flex items-center {{ request()->routeIs('student.scan-qr')  ? 'active' : '' }} ">
   
   <svg class="w-5 h-5 mr-2 {{ request()->routeIs('student.scan-qr') ? 'active' : '' }} "
         fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" 
              d="M3 7V5a2 2 0 012-2h2m10 0h2a2 2 0 012 2v2m0 10v2a2 2 0 01-2 2h-2M7 21H5a2 2 0 01-2-2v-2M8 12h8m-4-4v8">
        </path>
    </svg>
   ...
   class="nav-link flex items-center {{ request()->routeIs('student.attendance') ? 'active' : '' }} ">
    
    <svg class="w-5 h-5 mr-2 {{ request()->routeIs('student.attendance') ? 'active' : '' }} " 
         fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
...
<a href="{{ route('student.student.chat.view') }}"
   class="nav-link flex items-center {{ request()->routeIs('student.student.chat.view') ? 'active' : '' }} ">
    
   <svg class="w-5 h-5 mr-2 {{ request()->routeIs('student.student.chat.view') ? 'active' : '' }}" 
     fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
